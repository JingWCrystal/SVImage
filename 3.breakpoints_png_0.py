...
def main():
	# 纯合的
	vcf_path='/mnt/hde/gao/wj/SVImage/man_made_0.txt'
	vcf_path='/mnt/hde/gao/wj/simulate/testSimuResult11/bp.txt'
	# vcf_path='/mnt/hde/gao/wj/vcf/tools_made_vcf/NA12878_chr10.benchmark.vcf'
	# bam_path='/mnt/hde/gao/wj/simulate/testSimuResult1/500_DEL_400_DIV.bam'
	bam_path='/mnt/hde/gao/wj/artTEST3/out.bam'
	bam_path='/mnt/hde/gao/wj/simulate/testSimuResult11/500_DEL_400_DIV.bam'
	# 直接做 200*100的图，不截取了
	width=200
	height=100
